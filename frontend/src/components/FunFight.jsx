...
export default function FunFight() {
  ...
  return (
    <div style={{ textAlign: 'center', marginTop: '50px' }}>
      ...
      {!battleStarted ? (
        <div>
          <p>Enter your player name and select your avatar to begin the battle!</p>
          <input
            type="text"
            placeholder="Your Name"
            value={playerName}
            onChange={e => { setPlayerName(e.target.value); if (nameError) setNameError(''); }}
            style={{ margin: '10px', padding: '8px', fontSize: '1rem', borderRadius: '5px' }}
          />
          {nameError && (
            <div style={{ color: '#e74c3c', fontWeight: 600, marginTop: 4 }}>{nameError}</div>
          )}
          <div style={{ margin: '18px 0 10px 0' }}>
            <div style={{ marginBottom: 8, fontWeight: 500 }}>Choose your avatar:</div>
        ...
        <div>
          ...
          {winner ? (
            <>
              <h2 style={{ color: winner === playerName ? '#42b983' : '#e74c3c' }}>{winner} wins!</h2>
              <button
            ...
            <>
              <button
                ...
                style={{ marginTop: '20px', marginRight: '12px', padding: '10px 24px', fontSize: '1.1rem', borderRadius: '8px', background: '#42b983', color: '#fff', border: 'none', cursor: 'pointer' }}
              ...
              <button
                ...
                style={{ marginTop: '20px', marginRight: '12px', padding: '10px 24px', fontSize: '1.1rem', borderRadius: '8px', background: '#f1c40f', color: '#fff', border: 'none', cursor: 'pointer' }}
              ...
              <button
                ...
                style={{ marginTop: '20px', padding: '10px 24px', fontSize: '1.1rem', borderRadius: '8px', background: specialUsed ? '#aaa' : '#e74c3c', color: '#fff', border: 'none', cursor: specialUsed ? 'not-allowed' : 'pointer' }}
      ...
      <button
        ...
        style={{ marginTop: '40px', padding: '10px 30px', fontSize: '1.1rem', borderRadius: '8px', background: '#42b983', color: '#fff', border: 'none', cursor: 'pointer' }}
      >
        Go to Homepage
      </button>
    </div>
