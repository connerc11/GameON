...
export default function NumberSequenceLeaderboardPage() {
    ...
    <div style={{ background: '#111', minHeight: '100vh', minWidth: '100vw', color: '#fff', position: 'fixed', top: 0, left: 0, width: '100vw', height: '100vh', overflow: 'auto' }}>
      ...
      >
        <div style={{ display: 'flex', alignItems: 'center', justifyContent: 'center', marginBottom: 20 }}>
          ...
          <h1 style={{ color: '#fbbf24', fontSize: '1.8rem', textAlign: 'center', margin: 0, letterSpacing: 1, fontWeight: 900 }}>
            Number Sequence Leaderboard
          </h1>
        </div>
        
        <div style={{ marginBottom: 20, padding: 16, background: '#2a2a2a', borderRadius: 10, border: '1px solid #fbbf24', textAlign: 'center' }}>
          <h3 style={{ color: '#ffe066', marginBottom: 12, fontSize: '1.1rem' }}>🧠 Challenge Your Mind!</h3>
          <p style={{ color: '#fff', margin: 0, fontSize: '0.95rem', lineHeight: '1.4' }}>
            Complete mathematical sequences to earn points. Higher difficulty = more points!
          </p>
        </div>
        
        <Leaderboard game="numbersequence" limit={10} />
      </div>
    </div>
  );
}
